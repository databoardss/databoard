...
import { ApiResponse, AggregatedRecord } from '@/types/housing';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-3xl font-bold text-green-600">
              ${Math.round(data.records.reduce((acc: number, curr: AggregatedRecord) => acc + curr.price, 0) / data.records.length).toLocaleString()}
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <BarChart
              data={{
                labels: data.records.map((r: AggregatedRecord) => r.neighborhood),
                datasets: [{
                  label: 'Average Price',
                  data: data.records.map((r: AggregatedRecord) => r.price),
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <PieChart
              data={{
                labels: data.records.map((r: AggregatedRecord) => r.neighborhood),
                datasets: [{
                  data: data.records.map((r: AggregatedRecord) => r.count),
                  backgroundColor: [
                    'rgba(59, 130, 246, 0.5)',
                    'rgba(16, 185, 129, 0.5)',
                    'rgba(139, 92, 246, 0.5)',
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {data.records.map((record: AggregatedRecord, index: number) => (
                  <tr key={index}>
